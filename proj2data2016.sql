...
insert into classes values  ('c0001', 'CS', 432, 1, 2016, 'Spring', 3, 1);
insert into classes values  ('c0002', 'Math', 314, 1, 2015, 'Fall', 2, 2);
insert into classes values  ('c0003', 'Math', 314, 2, 2015, 'Fall', 3, 2);
insert into classes values  ('c0004', 'CS', 432, 1, 2015, 'Spring', 2, 1);
insert into classes values  ('c0005', 'CS', 240, 1, 2016, 'Spring', 5, 5);
insert into classes values  ('c0006', 'CS', 532, 1, 2016, 'Spring', 2, 1);
insert into classes values  ('c0007', 'Math', 221, 1, 2016, 'Spring', 6, 5);
